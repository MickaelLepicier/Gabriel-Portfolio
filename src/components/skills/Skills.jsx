    ...
    >
      <div className="container flex flex-wrap px-5 py-24 mx-auto items-center ">
        <div
          ...
          // className="md:w-1/2 md:pr-12 md:py-8 mb-10 md:mb-0 pd-10 "
        >
          <h1
            data-aos="fade-right"
            data-aos-delay="500"
          ...
          >
            ...
            Procurement: EBRD, World Bank, and AFDB procedures. <br/>

            Data: Excel, Power BI, and procurement monitoring dashboards. <br/>

            Communication: Policy briefs, tender guidelines, and bid evaluation reports.
